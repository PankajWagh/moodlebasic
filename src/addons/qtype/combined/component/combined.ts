 ...
 */
@Component({
    selector: 'addon-qtype-combined',
    templateUrl: 'addon-qtype-combined.html',
    styleUrls: ['combined.scss'],
})
export class AddonQtypeCombinedComponent extends CoreQuestionBaseComponent implements OnInit {

    constructor(elementRef: ElementRef) {
        super('AddonQtypeCombinedComponent', elementRef);
    }
